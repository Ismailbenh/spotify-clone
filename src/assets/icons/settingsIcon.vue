...
<template>
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="settingsIcon">
		<g fill="none" stroke="var(--color-icons)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
